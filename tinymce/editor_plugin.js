(function() {
    ...
    tinymce.create('tinymce.plugins.MediagalleryPlugin', {
        /**
        ...
        getInfo : function() {
            return {
                longname : 'Moodle Mediagallery tinymce plugin',
                author : 'Adam Olley',
                authorurl : 'http://www.netspot.com.au',
                version : "1.0"
            };
        }
    });
    ...
    // Register plugin.
    tinymce.PluginManager.add('mediagallery', tinymce.plugins.MediagalleryPlugin);
})();
